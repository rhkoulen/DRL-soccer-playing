...
from my_utils import create_opponent_env, policy_mapping_fn, SelfPlayCallback
from common import *
...
if __name__ == '__main__':
    ...
    tune.registry.register_env('SoccerVsLeague', create_opponent_env)

    dummy_env_ = create_opponent_env()
    ...
    analysis = tune.run(
        'PPO', # training scheme
        name='PPO_LSTM_Tuning_vs_League',
        config={
            # System Setup
            'num_gpus': NUM_GPUS,
            ...
            'log_level': 'ERROR',
            'framework': 'torch',
            # Multi-Agent League-Play RL Setup
            'env': 'SoccerVsLeague',
            ...
            'gamma': 0.99, # want a high gamma, since we really don't want to discount future goals
            ...
            'sgd_minibatch_size': 4096, # collate
        ...
        restore='./ray_results/PPO_LSTM_attempt/PPO_SoccerShaped_495de_00000_0_2026-04-23_04-06-09/checkpoint_001000/checkpoint-1000',
    )
